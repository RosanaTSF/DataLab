...
int main(){
    ...
    do{
        ...
        cout << "Digite 1 para inserir vertice.\n";
        cout << "Digite 2 para inserir aresta.\n";
        cout << "Digite 3 para imprimir o grau do vertice!\n";
        cout << "Digite 4 para imprimir o peso da aresta.\n";
        cout << "Digite 5 para imprimir a matriz de adjacencias.\n";
        cout << "Digite 6 para imprimir a lista de vertices.\n";
        cout << "Digite 7 para busca em largura!\n";
        cout << "Digite 8 para busca em profundidade!\n";
        cin >> opcao;
